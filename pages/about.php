...
<header class="header about-header">
  ...
  <div class="container mx-auto">
    ...
    <div class="mt-20"></div>
    <div class="p-20 bg-slate-900 rounded">
      <p class="text-white text-xl text-center">
        Нашият преподавател е опитен програмист в създаването на динамични уеб приложения със страст към споделянето на
        знания. Той съчетава опита си с подкрепящ и вдъхновяващ подход, за да помогне на учениците си да освоят уменията и уменията в
        уеб програмирането.
      </p>
    </div>
  </div>
